            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 border-b border-slate-850 pb-4">
                <button
                  ...
                  className={`flex-1 p-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${addressOption === 'saved'
                ...
                <button
                  ...
                  className={`flex-1 p-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${addressOption === 'new'
                    ? 'bg-indigo-500/10 border-indigo-500/40 text-white'
                    : 'bg-slate-950/20 border-slate-850 text-slate-400 hover:text-slate-200'
                    }`}
                >
